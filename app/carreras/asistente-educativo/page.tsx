        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Carrera Técnica en <span className="text-red-600">Asistente Educativo</span>
            </h1>
            <p className="text-lg text-red-600 font-semibold mb-4">RVOE: Validez Oficial</p>
            <p className="text-lg text-gray-600 leading-relaxed">
              Prepárate para trabajar en el desarrollo y educación de niños en edad preescolar con una formación
              integral y práctica.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                La carrera técnica en Asistente Educativo te prepara para trabajar con niños en edad preescolar,
                desarrollando habilidades pedagógicas, psicológicas y prácticas necesarias para apoyar su desarrollo
                integral.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Aprenderás sobre desarrollo infantil, metodologías de enseñanza, actividades lúdicas, primeros auxilios
                y todo lo necesario para ser un profesional en el cuidado y educación de los más pequeños.
              </p>
            </div>

            {/* Módulos y Competencias */}
            <div className="mb-12">
              <h3 className="text-2xl font-semibold mb-4">Módulos / Materias</h3>
              <ul className="grid md:grid-cols-2 gap-3 text-gray-700">
                <li>- Desarrollo infantil y psicología</li>
                <li>- Técnicas de planeación didáctica</li>
                <li>- Actividades lúdicas y recreación</li>
                <li>- Atención y nutrición infantil básica</li>
            ...
            <div className="mb-12">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <p className="text-gray-700 mb-4">Como egresado de Asistente Educativo podrás trabajar en:</p>
                <ul className="grid md:grid-cols-2 gap-3">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Guarderías y estancias infantiles</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Centros de desarrollo infantil</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Ludotecas</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Cuidado infantil privado</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-red-600 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700">Tu propia estancia infantil</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-red-600 text-white rounded-lg p-8 text-center">
              <h3 className="text-2xl font-bold mb-4">¿Listo para comenzar tu carrera como Asistente Educativo?</h3>
