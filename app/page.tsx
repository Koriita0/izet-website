...
export default function HomePage() {
  ...
  const careers = [
    {
      ...
      description: "Formación en estilismo, maquillaje, uñas y estética.",
      image: "/seleccionIZET/Belleza/IMG-20251021-WA0049.jpg",
    ...
    },
    {
      name: "Idioma Inglés",
      description:
        "Cursos intensivos y carrera técnica para dominar el idioma.",
      image: "/seleccionIZET/IdiomaIngles/ingles1.jpg",
      href: "/carreras/idioma-ingles",
    },
    {
      name: "Asistente Educativo",
      description:
        "Formación para apoyar procesos educativos y desarrollo infantil.",
      image: "/seleccionIZET/AsistenteEducativo/IMG-20251024-WA0043.jpg",
...

    {
      name: "Criminología",
      description:
        "Prevención, análisis e investigación de la criminalidad.",
      image: "/seleccionIZET/Criminologia/crimi1.jpg",
  ...
  useEffect(() => {
    const interval = setInterval(
      () =>
        setCurrentCareer((prev) => (prev + 1) % careers.length),
      5000,
    )
    return () => clearInterval(interval)
  }, [careers.length])

  const activeCareer = careers[currentCareer]
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                En IZET formamos profesionales técnicos altamente
                calificados, listos para enfrentar los desafíos del
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Conoce algunos de nuestros programas técnicos. Desliza
              entre las opciones o usa los botones para cambiar de
              carrera.
            </p>
          </div>

          <div className="max-w-4xl mx-auto">
            <div className="bg-[color:var(--muted)] rounded-2xl overflow-hidden shadow-md">
              <div className="grid md:grid-cols-2 gap-6 items-center p-6">
                <div className="relative w-full aspect-[4/3] rounded-lg overflow-hidden">
                  <Image
                    key={activeCareer.image}
      ...
      <section id="nosotros" className="py-20 bg-[color:var(--secondary)]">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[color:var(--foreground)] mb-4">
                Sobre IZET — Instituto Zacatecano de Estudios Técnicos
              </h2>
              <p className="text-gray-700 mb-4">
                Fundado para ofrecer formación técnica con validez
                oficial, IZET combina formación práctica y
                acompañamiento académico para jóvenes y adultos en
                Zacatecas. Nuestro objetivo es formar profesionistas
                listos para el mercado laboral local y regional.
              </p>
              ...
              <ul className="space-y-3 text-gray-700 mb-6">
                ...
                <li>
                  ...
                  y constancias al finalizar cursos técnicos.
                </li>
                <li>
                  <strong>Modalidad:</strong> Presencial con horarios
                  flexibles y cursos intensivos.
                </li>
              </ul>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Aulas, talleres y laboratorios adaptados para
                        formación técnica.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Equipo docente con experiencia en la industria y
                        pedagogía práctica.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Bolsa de trabajo y vinculación con empresas
                        locales.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Constancias y certificaciones tras la conclusión
                        de cursos y carreras.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                ...
                <p className="text-sm text-gray-700">
                  Formar técnicos profesionales con aptitudes prácticas y
                  éticas, capaces de integrarse al mercado laboral con
              ...
              <div>
                ...
                <p className="text-sm text-gray-700">
                  Ser referente regional en formación técnica,
                  promoviendo el desarrollo social y económico mediante
              ...
              <div>
                ...
                <p className="text-sm text-gray-700">
                  Compromiso, Responsabilidad, Inclusión y Excelencia.
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 grid md:grid-cols-2 gap-6 items-start">
              <div>
                ...
                <p className="text-gray-700 text-sm">
                  IZET nace para responder a la necesidad de formación
                  técnica en Zacatecas, ofreciendo programas prácticos
                  con orientación laboral desde sus primeros ciclos. A lo
                  largo de los años, hemos consolidado vínculos con
                  empresas locales y actualizado nuestros planes para
                  adaptarlos a las demandas del mercado.
                </p>
              </div>
              <div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Programas pensados para ofrecerte habilidades prácticas y
              salida laboral inmediata. Elige la ruta que mejor se adapte
              a tus intereses: carreras técnicas, preparatoria con enfoque
              práctico o cursos intensivos.
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto space-y-12">
            ...
            <div className="grid md:grid-cols-2 items-center gap-8">
              ...
              <div>
                <h3 className="text-2xl font-bold text-[color:var(--foreground)] mb-3">
                  Belleza Integral — Formación práctica y certificada
                </h3>
                <p className="text-gray-700 mb-4">
                  Programa líder en estilismo, maquillaje profesional,
                  alaciado, colorimetría, extensiones de pestaña y uñas.
                  Duración típica: 3 meses por curso. Al completar,
                  recibes constancia oficial del instituto y portafolio
                  práctico.
                </p>
            ...
            {/* Idioma Inglés — texto en negro */}
            <div className="grid md:grid-cols-2 items-center gap-8">
              <div className="md:pr-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-3">
                  Idioma Inglés — Curso Intensivo
                </h3>
                <p className="text-gray-800 mb-4">
                  Curso intensivo de 8 meses diseñado para dominar el
                  idioma con enfoque comunicativo y prácticas reales.
                  Ideal para quienes buscan mejorar su empleabilidad y
                  acceder a oportunidades internacionales.
                </p>
                <ul className="list-disc pl-5 text-gray-800 mb-4">
                  <li>
                    Clases presenciales y prácticas conversacionales
                  </li>
            ...
            <div className="grid md:grid-cols-2 items-center gap-8">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  atención al cliente. Incluye módulos sobre manejo del
                  negocio y servicio al cliente para quienes quieren
                  emprender su propia barbería.
                </p>
                <div className="flex gap-4">
                  <Link href="/carreras/barbero-profesional">
                    <Button className="bg-[color:var(--primary)] text-white">
                      Más información
                    </Button>
                  </Link>
      ...
      {/* Cursos y Talleres (sin cambios de fondo/texto) */}
      <section className="py-16">
        <div className="container mx-auto px-4 space-y-12">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-[color:var(--foreground)] mb-3">
              Cursos y Talleres
            </h2>
            <p className="text-gray-600">
              Cursos cortos diseñados para que desarrolles habilidades
              concretas y obtengas una constancia al finalizar. Perfectos
              si buscas aprender rápido y empezar a trabajar.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 items-center gap-8 bg-[color:var(--primary)] text-white rounded-lg p-8">
            ...
            <div>
              ...
              <p className="mb-4">
                Duración: 3 meses. Incluye prácticas en laboratorio y
          ...
          <div className="grid md:grid-cols-2 items-center gap-8">
            <div>
              <h3 className="text-2xl font-semibold text-[color:var(--foreground)] mb-3">
                Curso Intensivo de Inglés — 8 meses
              </h3>
              <p className="text-gray-700 mb-4">
                Programa intensivo estructurado en módulos con evaluación
                continua. Ideal para quienes buscan dominar el idioma en
                un periodo concentrado y mejorar su CV.
              </p>
              <ul className="list-disc pl-5 mb-4 text-gray-700">
                <li>Enfoque en comunicación oral y escrita</li>
                <li>
                  Prácticas con hablantes nativos y talleres de
                  conversación
                </li>
          ...
          <div className="grid md:grid-cols-2 items-center gap-8 bg-white rounded-lg p-8">
            ...
            <div>
              <h3 className="text-2xl font-semibold mb-3">
                Talleres Especiales y Certificaciones
              </h3>
              <p className="text-gray-700 mb-4">
                Ofrecemos talleres prácticos de fin de semana y
                certificaciones complementarias que fortalecen tu perfil
                profesional, como atención al cliente, gestión de redes
                sociales para emprendimientos, y herramientas digitales
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <a
                    href="mailto:contacto@izet.edu.mx"
